...
import { BadgeCheck, Bell, Landmark } from "lucide-react";
...
const benefits = [
  "Multi currency bank payouts",
  "Real time operational tracking",
  "Approval controls before release",
  "Proof records connected to projects",
];

export default function BankTransferComingSoonPage() {
  return (
    <AppShell>
        ...
        <div className="relative space-y-6">
          ...
          <section className="zila-unified-panel-soft overflow-hidden rounded-[32px] p-6 md:p-8">
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_340px]">
              <div>
                <IconTile size="md" glow="cyan" className="border-white/12 bg-white/[0.07] text-[#BFEFFF]">
                  <Landmark className="h-[18px] w-[18px]" strokeWidth={2} />
                </IconTile>
                <p className="mt-6 text-[12px] font-semibold uppercase tracking-[0.2em] text-[#7EE7F6]">Bank Transfer</p>
                ...
                <p className="mt-4 max-w-[620px] text-[15px] leading-[1.7] text-[#D7E3F8]">
                  We&apos;re building secure, multi currency bank payments with real time operational controls.
                </p>
              </div>
