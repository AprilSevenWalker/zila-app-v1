...
export default function PaymentsPage() {
  ...
  return (
    <AppShell>
      <div className="-mx-4 -mt-2 flex min-h-[calc(100vh-7.5rem)] flex-col overflow-hidden bg-[linear-gradient(160deg,#0D142B_0%,#171E46_42%,#1F2559_72%,#15374F_100%)] px-6 pb-28 pt-8 text-white md:-mx-6 md:rounded-[36px] md:px-8 md:pb-12 md:pt-10 lg:-mx-8 lg:px-10">
        ...
        <div className="relative flex flex-1 flex-col space-y-6 md:space-y-8">
          <div className="md:grid md:grid-cols-[minmax(280px,0.62fr)_minmax(0,1.38fr)] md:items-stretch md:gap-6 lg:gap-8">
            <div className="max-w-[320px] md:max-w-[360px] md:pt-3">
            ...
            <section className="mt-6 rounded-[34px] border border-cyan-300/14 bg-[linear-gradient(180deg,rgba(15,23,42,0.76),rgba(15,23,42,0.38))] p-8 shadow-[0_24px_58px_rgba(5,10,24,0.28),0_0_34px_rgba(34,211,238,0.07),inset_0_1px_0_rgba(255,255,255,0.08)] md:mt-0 md:h-full md:p-9">
          ...
          <div className="md:grid md:grid-cols-[minmax(0,1.32fr)_minmax(320px,0.86fr)] md:items-start md:gap-6 lg:gap-8">
            <div className="space-y-6 md:space-y-8">
              ...
              <MoneySourceSetupCard variant="dark" />
            ...
            <div className="mt-6 space-y-6 md:mt-0 md:space-y-8">
