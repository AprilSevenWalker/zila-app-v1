...
const operationalInsights = [
  "You can safely release the $4,300 supplier payout today.",
  "Zila protected 18% of incoming cash for upcoming obligations.",
  "Mobile money payout will not affect Friday supplier reserve.",
  "FX conversion prepared before supplier payout.",
];
    ...
    <AppShell>
      <div className="relative text-white">
        ...
        <div className="relative flex flex-col space-y-6 md:space-y-8">
          <section className="zila-unified-panel-soft relative overflow-hidden rounded-[30px] p-5 md:p-6 lg:p-7">
            ...
            <div className="relative z-10">
              <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 max-w-[560px] text-[15px] leading-[1.6] text-[#D7E3F8]">
                    Available money, next actions, and payouts across connected rails.
                  </p>
                </div>
              ...
              <div className="mb-5 grid gap-2 lg:grid-cols-4">
                {operationalInsights.map((insight) => (
                  <div key={insight} className="rounded-[16px] border border-white/12 bg-white/[0.065] px-4 py-3 text-[12px] font-medium leading-[1.45] text-[#E7EEFF] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition duration-200 hover:border-white/18 hover:bg-white/[0.085]">
                    {insight}
                  </div>
                ))}
              </div>
              ...
              <div className="grid gap-4 lg:grid-cols-[minmax(320px,1.1fr)_minmax(220px,0.72fr)_minmax(220px,0.72fr)]">
                <section className="rounded-[30px] border border-white/30 bg-[linear-gradient(180deg,rgba(28,73,121,0.96),rgba(13,35,68,0.98))] p-6 shadow-[0_24px_56px_rgba(13,35,68,0.30),inset_0_1px_0_rgba(255,255,255,0.16)]">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-4 text-[15px] leading-relaxed text-[#CBD5E1]">Total operational liquidity visible across connected money rails.</p>
                ...
                <div className="rounded-[24px] border border-white/46 bg-[linear-gradient(180deg,rgba(255,255,255,0.66),rgba(220,232,255,0.42))] p-4 text-[#17345F] shadow-[0_18px_42px_rgba(31,68,116,0.16),inset_0_1px_0_rgba(255,255,255,0.60)]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-[15px] font-semibold">Protected before payout</p>
                    </div>
                  </div>
                  ...
                  <p className="mt-3 text-[12px] leading-[1.55] text-[#4F6688]">$24,220 held aside before any payout is released.</p>
                </div>
                ...
                <div className="rounded-[22px] border border-cyan-200/28 bg-[linear-gradient(180deg,rgba(23,61,109,0.78),rgba(16,42,79,0.90))] p-4 shadow-[0_18px_38px_rgba(13,35,68,0.22),inset_0_1px_0_rgba(255,255,255,0.10)]">
                  <div className="flex items-center justify-between">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#7EE7F6]">Upcoming Movement</p>
                    <Route className="h-4 w-4 text-[#7EE7F6]" strokeWidth={2} />
                  </div>
                  <p className="mt-3 text-[24px] font-semibold tracking-[-0.04em] text-white">$4,300</p>
                  <p className="mt-1 text-[12px] text-[#C9D4F5]">Stablecoin wallet to supplier payout. Record ready.</p>
                </div>
              </div>
              ...
              <div className="mt-7 grid gap-4 lg:grid-cols-[minmax(0,1fr)_280px]">
                <div className="relative overflow-hidden rounded-[30px] border border-white/18 bg-[linear-gradient(135deg,rgba(9,25,50,0.80),rgba(23,61,109,0.74)_48%,rgba(16,42,79,0.92))] p-5 shadow-[0_24px_52px_rgba(13,35,68,0.24),inset_0_1px_0_rgba(255,255,255,0.12)] md:p-6">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-2 max-w-[560px] text-[22px] font-semibold leading-tight tracking-[-0.02em] text-white">Funds route safely across connected rails.</p>
                    </div>
                  ...
                  <div className="mt-6 space-y-4">
                    {liveMovements.map((movement) => (
                      <div key={movement.id} className="group relative rounded-[24px] border border-white/10 bg-white/[0.045] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.07)] transition duration-200 hover:-translate-y-0.5 hover:border-cyan-200/18 hover:bg-white/[0.07] hover:shadow-[0_18px_34px_rgba(13,35,68,0.18),0_0_22px_rgba(34,211,238,0.08),inset_0_1px_0_rgba(255,255,255,0.10)]">
                ...
                <div className="rounded-[26px] border border-[#D9FF57]/24 bg-[linear-gradient(180deg,rgba(217,255,87,0.14),rgba(16,42,79,0.78))] p-5 shadow-[0_18px_38px_rgba(13,35,68,0.20),inset_0_1px_0_rgba(255,255,255,0.10)]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#D9FF57]">Movement Record</p>
                      <p className="mt-1 text-[15px] font-semibold text-white">Each movement leaves a record</p>
                    </div>
                  </div>
                  <div className="mt-4 space-y-2">
                    {["Source verified", "Reserve protected", "Project checked", "Record ready"].map((item) => (
                      <div key={item} className="flex items-center justify-between gap-3 rounded-[14px] border border-white/10 bg-[#102A4F]/40 px-3 py-2">
                        <span className="text-[12px] font-medium text-[#E7EEFF]">{item}</span>
          ...
          <section className="zila-unified-panel-soft relative overflow-hidden rounded-[32px] p-5 md:p-6">
            ...
            <div className="relative grid gap-7 md:grid-cols-[minmax(0,1.24fr)_minmax(320px,0.76fr)] md:items-start lg:gap-9">
              <div>
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-3 max-w-[620px] text-[15px] leading-[1.65] text-[#D7E3F8]">
                      Connect bank, mobile money, and XRPL/Xaman so Zila can route funds without splitting your work across separate tools.
                    </p>
                  </div>
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                  {connectedRails.map((rail) => {
                    ...
                    return (
                      <div key={rail.id} className="group rounded-[18px] border border-white/8 bg-white/[0.035] p-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition duration-200 hover:border-white/14 hover:bg-white/[0.055]">
                ...
                <div className="mt-5 rounded-[26px] border border-white/8 bg-[radial-gradient(circle_at_24%_0%,rgba(126,231,246,0.08),transparent_30%),rgba(16,42,79,0.28)] p-4 md:p-5">
                  ...
                  <div className="relative flex flex-wrap items-center gap-3 overflow-hidden rounded-[22px] border border-white/6 bg-white/[0.025] p-3">
                    ...
                    {["Bank", "Stablecoin", "Mobile Money"].map((rail, index) => (
                      <div key={rail} className="relative z-10 flex items-center gap-2">
                        <span className="relative rounded-full border border-white/12 bg-[#102A4F]/88 px-4 py-2 text-[12px] font-semibold text-[#F4FBFF] shadow-[0_0_20px_rgba(34,211,238,0.06),inset_0_1px_0_rgba(255,255,255,0.08)] transition duration-200 hover:border-cyan-200/22 hover:shadow-[0_0_24px_rgba(34,211,238,0.12),inset_0_1px_0_rgba(255,255,255,0.10)]">
                ...
                <div className="mt-5 rounded-[24px] border border-white/6 bg-white/[0.025] p-4">
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-2 text-[14px] leading-[1.55] text-[#D7E3F8]">Use the rail that fits the job, while Zila keeps the reserve and proof trail connected.</p>
                    </div>
              ...
              <section className="rounded-[28px] border border-white/9 bg-[linear-gradient(180deg,rgba(16,42,79,0.56),rgba(9,25,50,0.62))] p-5 shadow-[0_18px_38px_rgba(13,35,68,0.14),inset_0_1px_0_rgba(255,255,255,0.07)]">
                <div className="flex items-center gap-3">
                ...
                <div className="mt-5 space-y-3">
                  <div className="rounded-[18px] border border-white/9 bg-white/[0.04] p-4 transition duration-200 hover:bg-white/[0.06]">
                  ...
                  {overview.needsAttention ? (
                    <Link href="/projects/harbour-road" className="block rounded-[18px] border border-orange-300/16 bg-[linear-gradient(180deg,rgba(251,146,60,0.14),rgba(244,63,94,0.07))] p-4 transition hover:-translate-y-0.5 hover:border-orange-200/30">
                  ...
                  <div className="rounded-[18px] border border-white/9 bg-white/[0.04] p-4">
                    ...
                    <div className="mt-3 space-y-2">
                      {["Source selected", "Amount verified", "Project updated"].map((item) => (
              ...
              <section className="rounded-[28px] border border-white/7 bg-white/[0.025] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                ...
                <div className="relative mt-5 space-y-0 before:absolute before:bottom-2 before:left-[4.15rem] before:top-2 before:w-px before:bg-[linear-gradient(180deg,rgba(126,231,246,0.18),rgba(217,255,87,0.14),rgba(126,231,246,0))]">
                  {recentOperations.map((operation) => (
                    <div key={operation.label} className="grid grid-cols-[4rem_1fr] gap-4 py-3 transition duration-200 hover:translate-x-0.5">
                      <p className="pt-0.5 text-[11px] font-semibold text-[#AFC0DD]">{operation.time}</p>
                      <div className="relative rounded-[16px] border border-white/6 bg-white/[0.025] px-3 py-3 transition duration-200 hover:border-white/12 hover:bg-white/[0.045]">
