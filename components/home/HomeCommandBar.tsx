...
export function HomeCommandBar() {
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-[30px] border border-[rgba(99,102,241,0.16)] bg-[linear-gradient(135deg,rgba(255,255,255,0.86),rgba(247,246,255,0.72))] p-6 shadow-[0_20px_44px_rgba(99,102,241,0.11),0_14px_30px_rgba(15,23,42,0.06),inset_0_1px_0_rgba(255,255,255,0.76)] backdrop-blur-xl md:hidden">
        ...
        <div className="relative">
          <div className="mb-4 flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-white/60 bg-white/65 shadow-[0_6px_14px_rgba(99,102,241,0.12)]">
      ...
      <div className="relative hidden overflow-hidden rounded-[38px] border border-[rgba(99,102,241,0.18)] bg-[linear-gradient(135deg,rgba(255,255,255,0.94),rgba(238,243,255,0.84)_42%,rgba(246,240,255,0.78))] p-9 shadow-[0_34px_80px_rgba(79,70,229,0.15),0_20px_46px_rgba(15,23,42,0.08),inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur-xl md:block">
        ...
        <div className="absolute right-20 top-20 h-2 w-2 rounded-full bg-white shadow-[0_0_22px_rgba(255,255,255,0.9)]" />
