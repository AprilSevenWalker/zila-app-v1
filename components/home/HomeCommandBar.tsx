...
export function HomeCommandBar() {
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-[30px] border border-white/22 bg-[linear-gradient(135deg,#214F83,#173D6D_48%,#102A4F)] p-4 shadow-[0_28px_68px_rgba(31,68,116,0.24),inset_0_1px_0_rgba(234,241,255,0.14)] backdrop-blur-xl sm:p-6 lg:hidden">
