...
export function ProjectsScreenContent({ projects }: { projects: Project[] }) {
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="md:grid md:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.92fr)] md:items-start md:gap-6 lg:gap-8">
        <div className="space-y-6 md:space-y-8">
          <div className="relative overflow-hidden rounded-[28px] border border-white/30 bg-gradient-to-br from-[#24295A] via-[#2B2D71] to-[#1E586C] p-6 shadow-[0_18px_38px_rgba(15,23,42,0.13)] md:p-7">
            ...
            <div className="relative">
              ...
              <p className="max-w-[310px] text-[18px] leading-[1.55] text-[#FBFBFF] md:max-w-[520px] md:text-[21px]">
                Project Horizon is about 6 days from a funding gap. A small move now keeps the week on track.
              </p>
            </div>
          </div>

          <div className="relative overflow-hidden rounded-[30px] border border-white/6 bg-gradient-to-br from-[#171F3A] via-[#1C214B] to-[#14405A] p-6 shadow-[0_26px_52px_rgba(15,23,42,0.18),0_0_0_1px_rgba(255,255,255,0.02)] md:p-7">
            ...
            <div className="relative">
              <Link href={`/projects/${featured.id}`} className="block">
                <div className="mb-5 flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      />
                      <h2 className="min-w-0 break-words text-[24px] font-semibold text-white md:text-[28px]">
                        {featured.name}
                      </h2>
                    </div>
                    <p className="mt-5 max-w-[290px] text-[13px] leading-[1.6] text-[#E2E8F0] md:max-w-[560px] md:text-[14px]">
                      {featured.stateSignal}
                    </p>
                  </div>
                ...
                <div className="mb-5 flex items-start gap-4 md:gap-6">
                ...
                <div className="rounded-[18px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.025))] px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] md:px-5 md:py-5">
                  ...
                  <p className="text-[15px] leading-[1.55] text-[#F8FAFC] md:text-[16px]">{featured.insight}</p>
                </div>
        ...
        <div className="mt-6 space-y-4 md:mt-0 md:space-y-6">
            ...
            {secondary.map((project, index) => {
              ...
              return (
                <Link
                  ...
                  className={`relative block w-full overflow-hidden rounded-[22px] border p-5 md:min-h-[220px] ${
                    tinted
          ...
          <Link
            ...
            className="block w-full rounded-[24px] border border-[rgba(18,20,23,0.07)] bg-white p-5 shadow-[0_10px_24px_rgba(15,23,42,0.06)] md:min-h-[220px] md:p-6"
          >
